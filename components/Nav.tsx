...
export default function Nav() {
  ...
  return (
    <>
      ...
      {/* Mobile Hamburger — sibling of <header> so it isn't trapped by the
          header's backdrop-filter containing block when scrolled */}
      <button
        className="fixed right-6 top-0 z-[70] flex h-[var(--header-height)] w-10 items-center justify-center md:hidden"
